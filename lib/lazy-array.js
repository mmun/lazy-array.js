...
import { findNodeBefore, splitNode, insertNode } from "lazy-array/helpers";
...
LazyArray.prototype.insertObjects = function(index, objects) {
  ...
  var node = findNodeBefore(this, index);

  if (node.index + node.lengths[0] !== index) {
    splitNode(this, node, node.index, index);
  }
